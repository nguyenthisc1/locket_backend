...
router.post(
  '/',
  CreateConversationDTO.validationRules(),
...
router.get(
  '/search',
  SearchConversationsDTO.validationRules(),
...
router.put(
  '/:conversationId',
  UpdateConversationDTO.validationRules(),
...
router.post(
  ...
  AddParticipantDTO.validationRules(),
...
router.delete(
  '/:conversationId/participants',
  RemoveParticipantDTO.validationRules(),
